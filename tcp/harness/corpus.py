...
def _d(
    ...
    *,
    ...
    return CapabilityDescriptor(
        ...
        input_formats=[
            FormatDescriptor(
                name=input_fmt, type=fmt_map.get(input_fmt, FormatType.TEXT)
            )
        ],
        output_formats=[
            FormatDescriptor(
                name=output_fmt, type=fmt_map.get(output_fmt, FormatType.TEXT)
            )
        ],
...
def _notion_agents_tools() -> list[CorpusEntry]:
    ...
    return [
        _entry(
            _d(
                "notion-chat-with-agent",
                commands=["chat_with_agent"],
                flags=NET | AUTH | JSON,
                latency_ms=5000,
                description="Send message to Notion AI agent",
            ),
            src,
            "network-auth",
        ),
        ...
        _entry(
            _d(
                "notion-describe-database",
                commands=["describe_database"],
                flags=NET | AUTH | JSON,
                latency_ms=1000,
        ...
        _entry(
            _d(
                ...
                flags=NET | AUTH | JSON,
                latency_ms=3000,
                description="Create a new Notion agent",
            ),
            src,
            "network-auth-write",
        ),
        ...
        _entry(
            _d(
                "notion-discover-agent",
                commands=["discover_agent"],
                flags=NET | AUTH | JSON,
                latency_ms=1500,
        ...
        _entry(
            _d(
                ...
                flags=NET | AUTH | JSON,
                latency_ms=1000,
                description="Export agent config",
            ),
            src,
            "network-auth",
        ),
        _entry(
            _d(
                "notion-get-conversation",
                commands=["get_conversation"],
                flags=NET | AUTH | JSON,
                latency_ms=1500,
                description="Read agent conversation",
            ),
            src,
            "network-auth",
        ),
        _entry(
            _d(
                "notion-handle-final-return",
                commands=["handle_final_return"],
                flags=NET | AUTH | JSON,
                latency_ms=2000,
                description="Process dispatch return",
            ),
            src,
            "network-auth-write",
        ),
...
def _playwright_tools() -> list[CorpusEntry]:
    ...
    return [
        ...
        _entry(
            _d(
                "browser-press-key",
                commands=["browser_press_key"],
                flags=NET,
                latency_ms=200,
                description="Send keypress",
            ),
            src,
            "network",
        ),
...
def _filesystem_tools() -> list[CorpusEntry]:
    ...
    return [
        ...
        _entry(
            _d(
                "fs-read-multiple",
                commands=["read_multiple_files"],
                flags=FILE | CapabilityFlags.BATCH_PROCESSING,
                latency_ms=10,
                output_fmt="text",
    ...
    return [
        ...
        _entry(
            _d(
                ...
                commands=["company_research_exa"],
                flags=NET,
                latency_ms=5000,
                description="Exa company research",
            ),
            src,
            "network",
        ),
        _entry(
            _d(
                "exa-code-context",
                commands=["get_code_context_exa"],
                flags=NET,
                latency_ms=3000,
                description="Exa code context",
            ),
            src,
            "network",
        ),
...
def _gmail_tools() -> list[CorpusEntry]:
    ...
    return [
        _entry(
            _d(
                "gmail-search",
                commands=["gmail_search_messages"],
                flags=NET | AUTH,
                latency_ms=1500,
...
def _google_calendar_tools() -> list[CorpusEntry]:
    ...
    return [
        ...
        _entry(
            _d(
                "gcal-find-free-time",
                commands=["gcal_find_my_free_time"],
                flags=NET | AUTH,
                latency_ms=2000,
    ...
    return [
        ...
        _entry(
            _d(
                ...
                commands=["get_deployment_build_logs"],
                flags=NET | AUTH,
                latency_ms=1500,
                output_fmt="text",
...
def _tally_tools() -> list[CorpusEntry]:
    ...
    return [
        _entry(
            _d(
                "tally-create-form",
                commands=["create_new_form"],
                flags=NET | AUTH,
                latency_ms=2000,
                description="Create new Tally form",
            ),
            src,
            "network-auth-write",
        ),
        ...
        _entry(
            _d(
                "tally-fetch-submissions",
                commands=["fetch_submissions"],
                flags=NET | AUTH,
                latency_ms=1500,
    ...
    return [
        _entry(
            _d(
                ...
                latency_ms=500,
                output_fmt="text",
                description="Semantic search over writing corpus",
            ),
            src,
            "file-read",
        ),
        _entry(
            _d(
                "rag-query-passages",
                commands=["query_passages"],
                flags=FILE,
                latency_ms=500,
                output_fmt="text",
                description="Query specific passages",
            ),
            src,
            "file-read",
        ),
        _entry(
            _d(
                ...
                flags=FILE,
                latency_ms=2000,
                description="Ingest file into corpus",
            ),
            src,
            "file-write",
        ),
...
def _nixos_tools() -> list[CorpusEntry]:
    ...
    return [
        ...
        _entry(
            _d(
                "nix-versions",
                commands=["nix_versions"],
                flags=CapabilityFlags.SUPPORTS_NETWORK,
                latency_ms=1000,
                output_fmt="json",
                description="Query Nix package versions",
            ),
            src,
            "network",
        ),
    ...
    return [
        ...
        _entry(
            _d(
                "ssh",
                commands=["ssh"],
                flags=CapabilityFlags.SUPPORTS_NETWORK | CapabilityFlags.AUTH_REQUIRED,
                latency_ms=5000,
                deps=["ssh"],
        ...
        _entry(
            _d(
                "rsync",
                commands=["rsync"],
                flags=FILE | CapabilityFlags.SUPPORTS_NETWORK,
                latency_ms=5000,
        ...
        _entry(
            _d(
                "docker",
                commands=["docker"],
                flags=CapabilityFlags.SUPPORTS_NETWORK | FILE,
                latency_ms=5000,
                output_fmt="text",
                deps=["docker"],
        ...
        _entry(
            _d(
                "jq",
                commands=["jq"],
                flags=FILE | CapabilityFlags.JSON_OUTPUT,
                latency_ms=5,
                input_fmt="json",
                output_fmt="json",
